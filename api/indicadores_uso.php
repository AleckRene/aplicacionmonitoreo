...
try {
    switch ($method) {
        ...
        case 'POST':
            ...
            $nivel_actividad = filter_input(INPUT_POST, 'nivel_actividad', FILTER_VALIDATE_INT);
            $frecuencia_recomendaciones = filter_input(INPUT_POST, 'frecuencia_recomendaciones', FILTER_VALIDATE_INT);
            $calidad_uso = filter_input(INPUT_POST, 'calidad_uso', FILTER_VALIDATE_INT);

            if (!$numero_usuarios || !$nivel_actividad || !$frecuencia_recomendaciones || !$calidad_uso) {
            ...
            $stmt->bind_param("iiii", $numero_usuarios, $nivel_actividad, $frecuencia_recomendaciones, $calidad_uso);
