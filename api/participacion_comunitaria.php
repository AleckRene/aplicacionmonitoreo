...
function addParticipacionComunitaria($conn) {
    ...
    $nivel_participacion = filter_input(INPUT_POST, 'nivel_participacion', FILTER_VALIDATE_INT);
    ...
    if (!$nivel_participacion || !$grupos_comprometidos || !$estrategias_mejora) {
    ...
    $stmt->bind_param("iss", $nivel_participacion, $grupos_comprometidos, $estrategias_mejora);
...
function updateParticipacionComunitaria($conn) {
    ...
    $id = intval($input['id']);
    $nivel_participacion = intval($input['nivel_participacion']);
    ...
    $stmt->bind_param("issi", $nivel_participacion, $grupos_comprometidos, $estrategias_mejora, $id);
